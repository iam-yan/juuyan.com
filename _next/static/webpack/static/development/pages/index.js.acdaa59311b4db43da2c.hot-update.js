...
module.exports = {
  ...
  typography: {
    display: ['e', "calc((100vw - 375px) * ".concat((160 - 64) / (1440 - 375), " + 64px)"), 1.25, weight.expressive.heavy],
    // display: ['e', scale[160], scale[200], weight.expressive.heavy],
    heading: [, scale[40], scale[48], weight.productive.heavy],
    subheading: [, scale[24], scale[32], weight.productive.heavy],
    label: [, scale[16], scale[24], weight.productive.heavy],
    body: [, scale[20], scale[24], weight.productive.regular] // display: ['e', scale[40], scale[48], weight.productive.heavy],
...
//# sourceMappingURL=index.js.acdaa59311b4db43da2c.hot-update.js.map